...
{
    public async Task Handle(DeletePointOfInterestCommand request, CancellationToken cancellationToken)
        => await writer.DeletePointOfInterestAsync(request.Id, cancellationToken);
}
