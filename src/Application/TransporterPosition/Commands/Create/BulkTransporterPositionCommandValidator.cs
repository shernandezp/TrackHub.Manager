...
public sealed class BulkTransporterPositionCommandValidator : AbstractValidator<BulkTransporterPositionCommand>
{
    public BulkTransporterPositionCommandValidator()
    {
