...
{
    public async Task<DeviceTransporterVm> Handle(GetDeviceTransporterByIdQuery request, CancellationToken cancellationToken)
        => await reader.GetDeviceTransporterAsync(request.TransporterId, cancellationToken);
