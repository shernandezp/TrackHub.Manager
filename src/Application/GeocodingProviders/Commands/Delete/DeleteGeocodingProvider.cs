...
{
    public async Task Handle(DeleteGeocodingProviderCommand request, CancellationToken cancellationToken)
        => await writer.DeleteGeocodingProviderAsync(request.Id, cancellationToken);
}
