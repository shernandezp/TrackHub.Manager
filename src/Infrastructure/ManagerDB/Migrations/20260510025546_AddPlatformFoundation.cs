...
namespace TrackHub.Manager.Infrastructure.Migrations
{
    ...
    public partial class AddPlatformFoundation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Existing transporters were tenant-scoped indirectly through their owning groups; the foundation requires the
            ...
            // invisible to tenant-scoped queries. Operators should reconcile data prior to deploying the foundation if
