...
using TrackHub.Manager.Application.DeviceTransporter.Queries.GetById;
using TrackHub.Manager.Application.DeviceTransporter.Queries.GetByOperator;
using TrackHub.Manager.Application.DeviceTransporter.Queries.GetMaster;
