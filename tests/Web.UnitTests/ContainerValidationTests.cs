...
public sealed class ContainerValidationTests
{
    ...
    private sealed class ManagerFactory : WebApplicationFactory<PlatformStatus>
    {
        protected override IHost CreateHost(IHostBuilder builder)
        {
            ...
            // service — in this module that would share one request-scoped DbContext across ten hosted jobs.
    ...
    {
        using var factory = new ManagerFactory();
