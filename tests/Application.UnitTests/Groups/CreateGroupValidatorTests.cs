...
public class CreateGroupValidatorTests
{
    ...
    {
        var command = new CreateGroupCommand(new GroupDto("", "Desc", true));
    ...
    {
        var command = new CreateGroupCommand(new GroupDto("Name", "", true));
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreateGroupCommand(default);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new CreateGroupCommand(new GroupDto("Fleet", "Description", true));
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveAnyValidationErrors();
    }

    [Test]
    public void Should_Not_Have_Error_When_Active_Is_False()
    {
        var command = new CreateGroupCommand(new GroupDto("Fleet", "Description", false));
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveAnyValidationErrors();
    }
}
